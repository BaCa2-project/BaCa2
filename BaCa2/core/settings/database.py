...
DB_BACKUP_DIR = BASE_DIR / 'backup'  # type: ignore # noqa: F821
_auto_create_dirs.add_dir(DB_BACKUP_DIR)  # type: ignore # noqa: F821
DB_SETTINGS_DIR = BASE_DIR / 'core' / 'db'  # type: ignore # noqa: F821
_auto_create_dirs.assert_exists_dir(DB_SETTINGS_DIR, instant=True)  # type: ignore # noqa: F821
